...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/Learner/${CND_PLATFORM}/bn_learning

${CND_DISTDIR}/Learner/${CND_PLATFORM}/bn_learning: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/Learner/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/Learner/${CND_PLATFORM}/bn_learning ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/bfirst_initializer.o: bfirst_initializer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bfirst_initializer.o bfirst_initializer.cpp
...
${OBJECTDIR}/simulated_annealing.o: simulated_annealing.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -s -I/usr/local/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/simulated_annealing.o simulated_annealing.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/Learner/${CND_PLATFORM}/bn_learning
