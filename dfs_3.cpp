...
initializers::DFS3Initializer::DFS3Initializer(){
    // Do nothing
}

initializers::DFS3Initializer::DFS3Initializer( std::vector<bestscorecalculators::BestScoreCalculator*> bestScoreCalculators ){
...
void initializers::DFS3Initializer::initialize(){
...
/*
 * Choose unvisited node uniformly
 * Choose next node based on edge weights
 */
greedysearch::PermutationSet initializers::DFS3Initializer::generate(){
...
std::vector<int> initializers::DFS3Initializer::traverse( int index ){
